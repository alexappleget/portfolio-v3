...
export const HeroSection = ({
  ...
  return (
    <section className="w-full md:min-h-screen flex flex-col md:flex-row items-center justify-center md:justify-start pt-40 pb-40 md:pt-0 md:pb-0 px-6 md:px-20">
